    ...
    <div>
      ...
      <div class="absolute top-1/4 w-screen">
        <div class="bg-white w-96 mx-auto p-5">
          <h1 class="text-xl text-indigo-600 font-bold py-5 text-center">Welcome!</h1>
          ...
          <%= f = form_for :player_name_form, "/", method: :post,
            ...
            <%= submit "OK", class: "items-center mt-5 justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base text-white hover:bg-indigo-700 md:py-4 md:px-10 md:text-lg" %>
        </div>
      </div>
    </div>
    """
